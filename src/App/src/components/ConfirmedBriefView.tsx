...
import { BRIEF_FIELD_CONFIG } from '../utils/constants';

interface ConfirmedBriefViewProps {
  brief: CreativeBrief;
}

export const ConfirmedBriefView = React.memo(function ConfirmedBriefView({ brief }: ConfirmedBriefViewProps) {
  return (
    <div className="message assistant" style={{ 
      ...
      <div style={{ 
        ...
        {BRIEF_FIELD_CONFIG.map(({ key, label }) => {
